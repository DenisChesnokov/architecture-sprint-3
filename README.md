...
![Диаграмма контейнеров](./diagrams/SH-ms-comtainers.png)

файл: [SH-ms-comtainers.puml](./diagrams/SH-ms-comtainers.puml)


#### C4 — Уровень компонентов (Components)
Пример для микросервиса управления устройствами:

![Диаграмма компонентов](./diagrams/SM-ms-components.png)

файл: [SM-ms-components.png](./diagrams/SM-ms-components.png)
...
![ER диаграмма](./diagrams/SH-ms-er.png)

файл: [SH-ms-er.puml](./diagrams/SH-ms-er.png)
